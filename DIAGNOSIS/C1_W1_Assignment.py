...
train_df = pd.read_csv("train-small-new.csv")
valid_df = pd.read_csv("valid-small-new.csv")

test_df = pd.read_csv("test-small-new.csv")
...
IMAGE_DIR = "images-small-new/images-small-new/"
...
data_neg = pd.DataFrame({"Class": [labels[l] for l in range(len(neg_contribution))], 
                         "Label": "Negative", 
